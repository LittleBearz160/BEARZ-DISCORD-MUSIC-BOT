...
module.exports = {
  ...
  description: "Quản lý DJ!", //the command description for helpcmd [OPTIONAL]
      ...
      if (!["add", "remove"].includes(add_remove)) {
        return message.reply({
          embeds: [new MessageEmbed()
            .setColor(ee.wrongcolor)
            .setFooter(ee.footertext, ee.footericon)
            .setTitle(`${client.allEmojis.x} **Vui lòng thêm __phương pháp hợp lệ__+Role!**`)
            .setDescription(`**Usage:**\n> \`${client.settings.get(message.guild.id, "prefix")}dj <add/remove> <@Role>\``)
          ],
        });
      }
      ...
      if (!Role) {
        return message.reply({
          embeds: [new MessageEmbed()
            .setColor(ee.wrongcolor)
            .setFooter(ee.footertext, ee.footericon)
            .setTitle(`${client.allEmojis.x} **Vui lòng thêm 1 phương pháp+__Role__!**`)
            .setDescription(`**Usage:**\n> \`${client.settings.get(message.guild.id, "prefix")}dj <add/remove> <@Role>\``)
          ],
        });
      }
      ...
      if (add_remove == "add") {
        if (client.settings.get(guild.id, "djroles").includes(Role.id)) {
          return message.reply({
            embeds: [
              ...
              .setColor(ee.wrongcolor)
              .setFooter(ee.footertext, ee.footericon)
              .setTitle(`${client.allEmojis.x} **Role này đã là 1 DJ-ROLE!**`)
            ],
          })
        }
        ...
        return message.reply({
          embeds: [
            ...
            .setColor(ee.color)
            .setFooter(ee.footertext, ee.footericon)
            .setTitle(`${client.allEmojis.check_mark} **Role \`${Role.name}\` đã được thêm vào ${client.settings.get(guild.id, "djroles").length - 1} DJ-Roles!**`)
        ...
        if (!client.settings.get(guild.id, "djroles").includes(Role.id)) {
          return message.reply({
            embeds: [
              ...
              .setColor(ee.wrongcolor)
              .setFooter(ee.footertext, ee.footericon)
              .setTitle(`${client.allEmojis.x} **Role này chưa phải DJ-ROLE!**`)
            ],
          })
        }
        ...
        return message.reply({
          embeds: [
            ...
            .setColor(ee.color)
            .setFooter(ee.footertext, ee.footericon)
            .setTitle(`${client.allEmojis.check_mark} **Role \`${Role.name}\` đã bị loại bỏ khỏi ${client.settings.get(guild.id, "djroles").length} DJ-Roles!**`)
            .addField(`🎧 **DJ-Role${client.settings.get(guild.id, "djroles").length > 1 ? "s": ""}:**`, `>>> ${djs}`, true)
          ],
        })
      }
