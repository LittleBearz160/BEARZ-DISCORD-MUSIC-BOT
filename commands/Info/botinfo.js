...
module.exports = {
    ...
    description: "Hiển thị thông tin Bot", //the command description for helpcmd [OPTIONAL]
            ...
            cpuStat.usagePercent(function (e, percent, seconds) {
                try {
                    ...
                    const botinfo = new MessageEmbed()
                        ...
                        .setFooter("Coded by: Little Bear#2004", "https://cdn.discordapp.com/attachments/919658410788679691/919658867569361006/discord-avatar-512-LYOCS.gif");
                    message.reply({
                        embeds: [botinfo]
                    });
