...
module.exports = {
  ...
  description: "Cung cấp cho bạn thông tin về tốc độ của Bot", //the command description for Slash Command Overview
  cooldown: 1,
  ...
  run: async (client, message, args) => {
    try {
      ...
      await message.reply({
          content: `${client.allEmojis.loading} Đang lấy thông tin ping...`,
          ephemeral: true
        })
