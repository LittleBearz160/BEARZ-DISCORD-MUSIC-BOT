...
module.exports = {
	...
	description: "Bật/tắt Autoplay", //the command description for Slash Command Overview
	cooldown: 5,
			...
			try {
				...
				message.reply({
					embeds: [new MessageEmbed()
					  .setColor(ee.color)
					  .setTimestamp()
					  .setTitle(`**${newQueue.autoplay ? `${client.allEmojis.check_mark} Bật` :`${client.allEmojis.x} Tắt`} Autoplay!**`)
